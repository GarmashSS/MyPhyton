...
# очки распределяются так:A, E, I, O, U, L, N, S, T, R – 1 очко; D, G – 2 очка; B, C, M, P – 3 очка; F, H, V, W, Y – 
# 4 очка; K – 5 очков; J, X – 8 очков; Q, Z – 10 очков. А русские буквы оцениваются так: А, В, Е, И, Н, О, Р, С, Т –
# 1 очко; Д, К, Л, М, П, У – 2 очка; Б, Г, Ё, Ь, Я – 3 очка; Й, Ы – 4 очка; Ж, З, Х, Ц, Ч – 5 очков; Ш, Э, Ю – 8 очков;
...
dict_1= {1:"АВЕИНОРСТ",2:"ДКЛЬПУ", 3:"БГЕЬЯ", 4:"ЙЫ",5:"ЖЗЦЧ", 8:"ШЭЮ", 10:"ФЩЪ"}
dict_2 ={1:"AEIOULNSTR", 2:"DG",3:"BCMP", 4:"FHVWY", 5:"K",8:"JX",10:"QZ"}
count=0
for i in x:
